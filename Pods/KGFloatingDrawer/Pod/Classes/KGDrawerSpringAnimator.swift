...
//    let kKGCenterViewDestinationScale:CGFloat = 0.7
    ...
    public var animationDuration: NSTimeInterval     = 0.6 //default:0.7
    public var initialSpringVelocity: CGFloat        = 9.1 // 9.1 m/s == earth gravity accel.
    public var springDamping: CGFloat                = 5.0 //default:0.8
